    ...
    <div className="p-4 m-2 mt-10 border-2 border-sky-200">
      ...
      <div className="flex justify-center mt-10">
        <div className="flex relative flex-wrap items-stretch mb-4 w-full">
          <div className="p-6 w-1/5 font-bold text-right">PNO</div>
      ...
      <div className="flex justify-center">
        <div className="flex relative flex-wrap items-stretch mb-4 w-full">
          <div className="p-6 w-1/5 font-bold text-right">PNAME</div>
          <div className="p-6 w-4/5 rounded-r border border-solid shadow-md">
            {product.pname}
          </div>
        </div>
      ...
      <div className="flex justify-center">
        <div className="flex relative flex-wrap items-stretch mb-4 w-full">
          <div className="p-6 w-1/5 font-bold text-right">PDESC</div>
          <div className="p-6 w-4/5 rounded-r border border-solid shadow-md">
            {product.pdesc}
          </div>
        </div>
      ...
      <div className="flex justify-end p-4">
        <button
          type="button"
          className="inline-block p-4 m-2 w-32 text-xl text-white bg-green-500 rounded"
